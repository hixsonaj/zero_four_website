...
export default function About() {
  return(
    <div className='About_Container'>
      ...
      <h4>
        <a href="/Alex_Hixson_Resume.pdf" target="_blank" rel="noopener noreferrer">Resume</a>
        <br/>
        <a href="https://www.linkedin.com/in/hixsonaj/">LinkedIn</a><br/>
        <a href="https://github.com/hixsonaj">GitHub</a>
